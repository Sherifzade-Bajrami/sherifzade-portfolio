const experience = [
  {
    ...
    highlights: [
      "Custom WordPress themes and tailored website functionality",
      "Dynamic content solutions with ACF and PHP",
      "WooCommerce stores, product systems and checkout customization",
      "Responsive frontend development with JavaScript and modern CSS",
      "Headless WordPress integrations with React, Gatsby and GraphQL",
      "Performance optimization, technical SEO and debugging",
    ],
    technologies: [
      "WordPress",
      "PHP",
          ...
          <div className="mt-14 border-t border-white/[0.08]">
            {experience.map((item) => (
              <article
                ...
                className="group grid gap-6 border-b border-white/[0.08] py-12 lg:grid-cols-[180px_1fr]"
              >
                ...
                {/* CONTENT */}
                <div>
                  <h3 className="text-[30px] font-semibold tracking-[-1px] text-zinc-100">
                    {item.role}
                  </h3>
                  ...
                  <p className="mt-6 max-w-[760px] text-[16px] leading-7 text-zinc-400">
                    {item.description}
                  </p>
                  ...
                  {/* DECORATIVE LINE */}
                  <div className="mt-9 h-px w-10 bg-violet-400 transition-all duration-500 group-hover:w-16" />
                </div>
