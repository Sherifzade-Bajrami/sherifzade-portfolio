const experience = [
  {
    ...
    description:
      "Developing and maintaining modern websites and web applications across frontend development, WordPress and ecommerce. My work includes responsive UI development, custom WordPress solutions, WooCommerce, debugging, performance optimization and building maintainable web experiences.",
    technologies: [
      "React",
      "JavaScript",
      "Tailwind CSS",
